  ...
  <div class="leftpanel">
    ...
    <div class="leftpanelinner">
      ...
      <ul class="nav nav-pills nav-stacked nav-bracket">
        ...
        <li class="active"><a href="email.html"><i class="fa fa-envelope-o"></i> <span>Email</span></a></li>
    ...
    <div class="contentpanel panel-email">
        ...
        <div class="row">
            <div class="col-sm-3 col-lg-2">
                <button class="btn btn-danger btn-block btn-compose-email">Compose Email</button>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="pull-right">
                            ...
                            <div class="btn-group mr5">
                                <button class="btn btn-white" type="button"><i class="fa fa-reply"></i></button>
                        ...
                        <div class="btn-group mr10">
                            <button class="btn btn-white tooltips" type="button" data-toggle="tooltip" title="Read Previous Email"><i class="glyphicon glyphicon-chevron-left"></i></button>
                            <button class="btn btn-white tooltips" type="button" data-toggle="tooltip" title="Read Next Email"><i class="glyphicon glyphicon-chevron-right"></i></button>
                        </div>
