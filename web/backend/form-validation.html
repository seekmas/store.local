      ...
      <ul class="nav nav-pills nav-stacked nav-bracket">
        ...
        <li class="nav-parent nav-active active"><a href="#"><i class="fa fa-edit"></i> <span>Forms</span></a>
          <ul class="children" style="display: block">
            ...
            <li class="active"><a href="form-validation.html"><i class="fa fa-caret-right"></i> Form Validation</a></li>
  ...
  <div class="mainpanel">
    ...
    <div class="contentpanel">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <form id="basicForm" action="http://themepixels.com/demo/webpage/bracket/form-validation.html" class="form-horizontal">
        ...
        <div class="col-md-6">
          <form id="basicForm2" action="http://themepixels.com/demo/webpage/bracket/form-validation.html" class="form-horizontal">
          <div class="panel panel-default">
              <div class="panel-heading">
                <div class="panel-btns">
                  <a href="#" class="panel-close">&times;</a>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <form id="basicForm3" action="http://themepixels.com/demo/webpage/bracket/form-validation.html">
          <div class="panel panel-default">
              <div class="panel-heading">
                <div class="panel-btns">
                  <a href="#" class="panel-close">&times;</a>
        ...
        <div class="col-md-6">
          <form id="basicForm4" action="http://themepixels.com/demo/webpage/bracket/form-validation.html">
          <div class="panel panel-default">
              <div class="panel-heading">
                <div class="panel-btns">
                  <a href="#" class="panel-close">&times;</a>
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <select id="flowers" name="flowers" title="Please select at least 2 flowers" class="form-control" size="5" multiple="multiple" required>
