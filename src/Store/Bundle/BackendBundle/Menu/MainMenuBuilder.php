...
class MainMenuBuilder extends ContainerAware
{
    public function mainMenu( FactoryInterface $factory , array $options)
    {
        ...
        //home menu
        $menu->addChild('home',['attributes' =>['icon'=>'fa fa-shopping-cart'],'label' => '商店信息','route' => '']);
        $menu['home']->addChild('home_config',['attributes' =>['icon'=>'fa fa-file-text-o'],'label' => '更新信息','route' => 'store']);
        //product menu
        $menu->addChild('product',['attributes' =>['icon'=>'fa fa-gift'],'label' => '产品信息','route' => '']);
        ...
        //category menu
        $menu->addChild('category',['attributes' =>['icon' => 'fa fa-book'],'label' => '产品分类' ,'route' => '']);
